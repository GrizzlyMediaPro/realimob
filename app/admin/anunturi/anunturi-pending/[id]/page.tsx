...
import { MdLocationOn, MdBed, MdBathroom, MdSquareFoot, MdLayers, MdCalendarToday, MdAttachMoney, MdArrowBack, MdPending } from "react-icons/md";
...
export default async function AdminAnuntPendingPage({
  params,
}: AnuntPageProps) {
            ...
            <section className="space-y-6 md:space-y-8 mb-0">
              ...
              <div className="p-6 rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="mt-4 p-3 rounded-lg bg-yellow-100 dark:bg-yellow-900/30">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      Acest anunț așteaptă aprobare pentru a fi publicat. Te
                      rugăm să verifici informațiile și să aprobi sau să
                      respingi anunțul.
                    </p>
                  </div>
                </div>
