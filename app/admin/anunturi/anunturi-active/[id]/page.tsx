...
import { MdLocationOn, MdBed, MdBathroom, MdSquareFoot, MdLayers, MdCalendarToday, MdAttachMoney, MdArrowBack, MdCheckCircle } from "react-icons/md";
...
export default async function AdminAnuntActivePage({ params }: AnuntPageProps) {
        ...
        <div className="w-full max-w-[1250px] mx-auto">
          ...
          >
            ...
            <section className="space-y-6 md:space-y-8 mb-0">
              ...
              {/* Descriere (la fel ca pe listing-urile publice) */}
