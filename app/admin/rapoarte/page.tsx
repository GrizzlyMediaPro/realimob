        ...
        <div className="w-full max-w-[1250px] mx-auto space-y-8 md:space-y-12">
          <div>
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-galak-regular)" }}
            >
              Vizualizează sumarul analitic și exportă același set de date ca fișier
              CSV (Excel) sau PDF.
            </p>
          </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-galak-regular)" }}
                  >
                    Conține aceleași agregări ca pagina Analitică: anunțuri, agenți,
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    <Link
                      ...
                      style={{ fontFamily: "var(--font-galak-regular)" }}
                    >
                      Deschide Analitica (grafice detaliate) →
                    </Link>
                  </div>
                </div>
              )}
